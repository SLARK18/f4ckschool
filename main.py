...
def show_chapter(chapter):
    return render_template("base_text_info.html", html_stat=open(r'templates\История развития\Роль стандартов и протоколов.html', encoding='utf-8').read(), menu_list=MENU_LIST)
